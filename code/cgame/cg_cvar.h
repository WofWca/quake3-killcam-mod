...
CG_CVAR( cg_killcamTimescaleAfter, "cg_killcamTimescaleAfter", "20", 0 )
...
CG_CVAR( cg_killcamTimescaleFadeOut, "cg_killcamTimescaleFadeOut", "400", 0 )
...
CG_CVAR( cg_killcamHeight, "cg_killcamHeight", "24", 0 )
CG_CVAR( cg_killcamSide, "cg_killcamSide", "-15", 0 )
...
CG_CVAR( cg_killcamMissileHeight, "cg_killcamMissileHeight", "", 0 )
CG_CVAR( cg_killcamMissileSide, "cg_killcamMissileSide", "", 0 )
